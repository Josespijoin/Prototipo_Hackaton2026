...
Utilizar los archivos de la carpeta 'Tests', para hacer pruebas mediante Python o Java para acceder a la información del mapa georreferenciado mediante el API REST.
